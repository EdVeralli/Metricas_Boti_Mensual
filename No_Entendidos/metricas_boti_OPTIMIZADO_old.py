...
"""
=============================================================================
MÉTRICAS BOTI - VERSIÓN OPTIMIZADA CON PASO 6 RÁPIDO
=============================================================================
Versión Optimizada: PASO 6 usa operaciones vectorizadas (100x más rápido)

CAMBIO PRINCIPAL:
- PASO 6 optimizado: de 60 minutos a 2 segundos
- Resto del código: IDÉNTICO al original
...
# =============================================================================
# CONFIGURACIÓN - EDITA ESTAS VARIABLES SEGÚN TU MES
# =============================================================================

DIRECTORIO_TRABAJO = 'C:/GCBA/Metricas_Boti_Mensual/No_Entendidos'

# Período - CAMBIAR SEGÚN EL MES QUE QUIERAS ANALIZAR
...
def calcular_promedios_boti():
    try:
        ...
        # =================================================================
        # PASO 2: CARGAR ARCHIVOS AUXILIARES
        # =================================================================
...
if __name__ == "__main__":
    print("\n" + "=" * 80)
    print("  MÉTRICAS BOTI - VERSIÓN OPTIMIZADA")
