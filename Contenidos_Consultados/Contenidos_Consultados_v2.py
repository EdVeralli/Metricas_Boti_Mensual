# -*- coding: utf-8 -*-
'''
Script para descargar y procesar Contenidos Consultados desde Athena (v2)
Descarga la vista boti_vw_buscador_rulename y genera tabla completa de contenidos.

VERSION 2: Implementa filtrado en 2 capas como el Power BI original:
...
if __name__ == "__main__":
    print("")
    print("=" * 60)
    print("SCRIPT: CONTENIDOS CONSULTADOS - QUERY ATHENA (v2)")
    print("=" * 60)
    ...
    print("")
    print("LÓGICA (v2 - filtrado en 2 capas como el PBI):")
